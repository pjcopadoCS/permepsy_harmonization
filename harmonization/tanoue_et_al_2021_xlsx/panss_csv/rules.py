import harmonization.common.panss.re_calcule as rc

def harmonize(df,dataset,var):
    rc.harmonize(df,dataset,var)
...
def harmonize(df,dataset,var):
    ...
    range_items = [range(1,8)]*30*2
    range_items_n = [range(7,50),range(7,50),range(16,113),range(30,211)]*2 
